...
<pre>
npm i <a href=https://www.npmjs.com/package/boujee>boujee</a>
</pre>

Don't want to set up a build environment? Download boujee from [unpkg](https://unpkg.com/boujee/boujee.js) (or [jsdelivr](https://cdn.jsdelivr.net/npm/boujee/boujee.js)) and it will be globally available through the `window.boujee` object. Works in ES5-friendly browsers >=IE9.
...
Here is the first example to get you started. Go ahead and [try it online](https://codepen.io/jorgebucaran/pen/LdLJXX) or find [more examples here](https://codepen.io/search/pens?q=boujee&page=1&order=superviewularity&depth=everything&show_forks=false).
...
The [next example](https://codepen.io/jorgebucaran/pen/KoqxGW) shows how to use HTML attributes to synchronize the text of an input with a heading element. boujee nodes support [HTML attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes), [SVG attributes](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute), [DOM events](https://developer.mozilla.org/en-US/docs/Web/Events), [keys](#keys) and [lifecycle events](#lifecycle-events).
...
boujee is MIT licensed. See [LICENSE](/LICENSE.md).
